...
package com.flym.dennikn.activity;
...
import com.flym.dennikn.adapter.DrawerAdapter;
import com.flym.dennikn.fragment.EntriesListFragment;
...
import com.flym.dennikn.provider.FeedDataContentProvider;
import com.flym.dennikn.service.FetcherService;
import com.flym.dennikn.service.RefreshService;
import com.flym.dennikn.utils.PrefUtils;
import com.flym.dennikn.utils.UiUtils;
...
public class HomeActivity extends BaseActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public void onLoadFinished(Loader<Cursor> cursorLoader, Cursor cursor) {
        ...
        if (mDrawerAdapter != null) {
         /*   Log.e("got the poijt","cursor size+ "+cursor.getCount());
            if(cursor.getCount()==0) {
                Log.e("got the poijt", "nothing to load");
                return;
            }*/
    ...
    private void selectDrawerItem(int position) {
        ...
        if (PrefUtils.getBoolean(PrefUtils.FIRST_OPEN, true)) {
            ...
            FeedDataContentProvider.addFeed(this, "https://dennikn.sk/svet/feed/", "Zahraničie", true);
