...
import com.flym.echo24.adapter.DrawerAdapter;
import com.flym.echo24.fragment.EntriesListFragment;
...
import com.flym.echo24.provider.FeedDataContentProvider;
import com.flym.echo24.service.FetcherService;
import com.flym.echo24.service.RefreshService;
...
public class HomeActivity extends BaseActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void selectDrawerItem(int position) {
        ...
        if (PrefUtils.getBoolean(PrefUtils.FIRST_OPEN, true)) {
            ...
            FeedDataContentProvider.addFeed(this, "http://echo24.cz/rss/s/svet", "Svět", true);
            ...
            FeedDataContentProvider.addFeed(this, "http://echo24.cz/rss/s/nazory", "Názory", true);
